...
ruminants and cattle. The relevant changes for this code are:
    - The updated compartmental model saves outputs from all scenarios in a
    single file instead of separate files
    - The updated parameters for cattle are for a single year and national
    level only, so the yearly (2017-2021) and regional results are out of date
...
# To match cattle and poultry files, and for consistency with later data processing
...
#### Cattle
# =============================================================================
#!!! Updated results using Murdoch's parameters don't universally follow the prefix pattern.
cattle_suffixes = [
    'current'
