...
CLM_S_PPR_prod <- combined_production(production_system_code = "CLM",
                                      ...
                                      impact_file = "input/impact_inputs_sr.xlsx",
                                      affected_value = list(CP_J = CLM_S_PPR_freq$stratified_I$I$J,
                                                            CP_SA = CLM_S_PPR_freq$stratified_I$I$SA,
                                                            CP_AF = CLM_S_PPR_freq$stratified_I$I$AF,
                                                            CP_AM = CLM_S_PPR_freq$stratified_I$I$AM,
                                                            CP_Lab_SR = Reduce("+",CLM_S_PPR_freq$stratified_I$I),
                                                            CP_Health = Reduce("+",CLM_S_PPR_freq$stratified_I$I)),
...
Past_S_PPR_prod <- combined_production(production_system_code = "Past",
                                       ...
                                       ahle_scenario_file = "scenarios/AHLE scenario parameters SMALLRUMINANTS.xlsx",
                                       impact_file = "input/impact_inputs_sr.xlsx",
                                       affected_value = list(CP_J = Past_S_PPR_freq$stratified_I$I$J,
                                                             CP_SA = Past_S_PPR_freq$stratified_I$I$SA,
                                                             CP_AF = Past_S_PPR_freq$stratified_I$I$AF,
                                                             CP_AM = Past_S_PPR_freq$stratified_I$I$AM,
                                                             CP_Lab_SR = Reduce("+",Past_S_PPR_freq$stratified_I$I),
                                                             CP_Health = Reduce("+",Past_S_PPR_freq$stratified_I$I)),
...
CLM_G_PPR_prod <- combined_production(production_system_code = "CLM",
                                      ...
                                      ahle_scenario_file = "scenarios/AHLE scenario parameters SMALLRUMINANTS.xlsx",
                                      impact_file = "input/impact_inputs_sr.xlsx",
                                      affected_value = list(CP_J = CLM_G_PPR_freq$stratified_I$I$J,
                                                            CP_SA = CLM_G_PPR_freq$stratified_I$I$SA,
                                                            CP_AF = CLM_G_PPR_freq$stratified_I$I$AF,
                                                            CP_AM = CLM_G_PPR_freq$stratified_I$I$AM,
                                                            CP_Lab_SR = Reduce("+",CLM_G_PPR_freq$stratified_I$I),
                                                            CP_Health = Reduce("+",CLM_G_PPR_freq$stratified_I$I)),
...
Past_G_PPR_prod <- combined_production(production_system_code = "Past",
                                       ...
                                       ahle_scenario_file = "scenarios/AHLE scenario parameters SMALLRUMINANTS.xlsx",
                                       impact_file = "input/impact_inputs_sr.xlsx",
                                       affected_value = list(CP_J = Past_G_PPR_freq$stratified_I$I$J,
                                                             CP_SA = Past_G_PPR_freq$stratified_I$I$SA,
                                                             CP_AF = Past_G_PPR_freq$stratified_I$I$AF,
                                                             CP_AM = Past_G_PPR_freq$stratified_I$I$AM,
                                                             CP_Lab_SR = Reduce("+",Past_G_PPR_freq$stratified_I$I),
                                                             CP_Health = Reduce("+",Past_G_PPR_freq$stratified_I$I)),
...
CLM_S_Bruc_prod <- combined_production(production_system_code = "CLM",
                                             ...
                                             ahle_scenario_file = "scenarios/AHLE scenario parameters SMALLRUMINANTS.xlsx",
                                             impact_file = "input/impact_inputs_sr.xlsx",
                                             affected_value = list(CP_J = CLM_S_Bruc_freq$stratified_I$I$J,
                                                                   CP_AF = CLM_S_Bruc_freq$stratified_I$I$AF,
                                                                   CP_Lab_SR = Reduce("+",CLM_S_Bruc_freq$stratified_I$I),
                                                                   CP_Health = Reduce("+",CLM_S_Bruc_freq$stratified_I$I)),
...
Past_S_Bruc_prod <- combined_production(production_system_code = "Past",
                                              ...
                                              ahle_scenario_file = "scenarios/AHLE scenario parameters SMALLRUMINANTS.xlsx",
                                              impact_file = "input/impact_inputs_sr.xlsx",
                                              affected_value = list(CP_J = Past_S_Bruc_freq$stratified_I$I$J,
                                                                    CP_AF = Past_S_Bruc_freq$stratified_I$I$AF,
                                                                    CP_Lab_SR = Reduce("+", Past_S_Bruc_freq$stratified_I$I),
                                                                    CP_Health = Reduce("+", Past_S_Bruc_freq$stratified_I$I)),
...
CLM_G_Bruc_prod <- combined_production(production_system_code = "CLM",
                                             ...
                                             ahle_scenario_file = "scenarios/AHLE scenario parameters SMALLRUMINANTS.xlsx",
                                             impact_file = "input/impact_inputs_sr.xlsx",
                                             affected_value = list(CP_J = CLM_G_Bruc_freq$stratified_I$I$J,
                                                                   CP_AF = CLM_G_Bruc_freq$stratified_I$I$AF,
                                                                   CP_Lab_SR = Reduce("+",CLM_G_Bruc_freq$stratified_I$I),
                                                                   CP_Health = Reduce("+",CLM_G_Bruc_freq$stratified_I$I)),
...
Past_G_Bruc_prod <- combined_production(production_system_code = "Past",
                                           ...
                                           ahle_scenario_file = "scenarios/AHLE scenario parameters SMALLRUMINANTS.xlsx",
                                           impact_file = "input/impact_inputs_sr.xlsx",
                                           affected_value = list(CP_J = Past_G_Bruc_freq$stratified_I$I$J,
                                                                 CP_AF = Past_G_Bruc_freq$stratified_I$I$AF,
                                                                 CP_Lab_SR = Reduce("+",Past_G_Bruc_freq$stratified_I$I),
                                                                 CP_Health = Reduce("+",Past_G_Bruc_freq$stratified_I$I)),
...
## Cattle CLM ----
CLM_C_FMD_freq <- SEBI_to_incidence(SEBI_species=c("Cattle"),
                               SEBI_cause="Foot and mouth disease",
                               SEBI_test=c("ELISA (3ABC)"),
                               freq_col = "C_FMD",
                               age_col = "CLM_C_FMD",
                               n.iter=60000,
                               n.burnin=10000)
CLM_C_FMD_prod <- combined_production(production_system_code = "CLM",
                                       species_code = "C",
                                       cause_code = "FMD",
                                       ahle_scenario_file = "scenarios/AHLE scenario parameters CATTLE.xlsx",
                                       impact_file = "input/impact_inputs_cattle.xlsx",
                                       affected_value = list(CP_J = sample(CLM_C_FMD_freq$stratified_I$I$J, 10000), 
                                                             CP_SA = sample(CLM_C_FMD_freq$stratified_I$I$SA, 10000), 
                                                             CP_AF = sample(CLM_C_FMD_freq$stratified_I$I$AF, 10000),  
                                                             CP_AM = sample(CLM_C_FMD_freq$stratified_I$I$AM, 10000),
                                                             CP_O = sample(CLM_C_FMD_freq$stratified_I$I$O, 10000),
                                                             CP_Health_Exp = sample(Reduce("+",CLM_C_FMD_freq$stratified_I$I), 10000)),
                                       affected_change = list(CP_Milk=sample(CLM_C_FMD_freq$stratified_I$I$AF, 10000),
                                                              CP_Draught= sample(CLM_C_FMD_freq$stratified_I$I$O, 10000)))
CLM_C_FMD <- pert_distributions("CLM_C_FMD", CLM_C_FMD_prod)
update_AHLE_scenarios(AHLE_scenario_file="scenarios/cattle_disease_scenarios.xlsx",
                      ideal_col = "CLM_C_Ideal",
                      affected_parameters_object=CLM_C_FMD,
                      col_name = "CLM_C_FMD",
                      new_file_name = "scenarios/cattle_disease_scenarios.xlsx")

## Cattle Pastoral ----
Past_C_FMD_freq <- SEBI_to_incidence(SEBI_species=c("Cattle"),
                                    SEBI_cause="Foot and mouth disease",
                                    SEBI_test=c("ELISA (3ABC)"),
                                    freq_col = "C_FMD",
                                    age_col = "Past_C_FMD",
                                    n.iter=60000,
                                    n.burnin=10000)
Past_C_FMD_prod <- combined_production(production_system_code = "Past",
                                      species_code = "C",
                                      cause_code = "FMD",
                                      ahle_scenario_file = "scenarios/AHLE scenario parameters CATTLE.xlsx",
                                      impact_file = "input/impact_inputs_cattle.xlsx",
                                      affected_value = list(CP_J = sample(Past_C_FMD_freq$stratified_I$I$J, 10000), 
                                                            CP_SA = sample(Past_C_FMD_freq$stratified_I$I$SA, 10000), 
                                                            CP_AF = sample(Past_C_FMD_freq$stratified_I$I$AF, 10000),  
                                                            CP_AM = sample(Past_C_FMD_freq$stratified_I$I$AM, 10000),
                                                            CP_Health_Exp = sample(Reduce("+",Past_C_FMD_freq$stratified_I$I), 10000)),
                                      affected_change = list(CP_Milk=sample(Past_C_FMD_freq$stratified_I$I$AF, 10000)))
Past_C_FMD <- pert_distributions("Past_C_FMD", Past_C_FMD_prod)
update_AHLE_scenarios(AHLE_scenario_file="scenarios/cattle_disease_scenarios.xlsx",
                      ideal_col = "Past_C_Ideal",
                      affected_parameters_object=Past_C_FMD,
                      col_name = "Past_C_FMD",
                      new_file_name = "scenarios/cattle_disease_scenarios.xlsx")

## Cattle Periurban Dairy ----
PUD_C_FMD_freq <- SEBI_to_incidence(SEBI_species=c("Cattle"),
                                     SEBI_cause="Foot and mouth disease",
                                     SEBI_test=c("ELISA (3ABC)"),
                                     freq_col = "C_FMD",
                                     age_col = "PUD_C_FMD",
                                     n.iter=60000,
                                     n.burnin=10000)
PUD_C_FMD_prod <- combined_production(production_system_code = "PUD",
                                       species_code = "C",
                                       cause_code = "FMD",
                                       ahle_scenario_file = "scenarios/AHLE scenario parameters CATTLE.xlsx",
                                       impact_file = "input/impact_inputs_cattle.xlsx",
                                       affected_value = list(CP_J = sample(PUD_C_FMD_freq$stratified_I$I$J, 10000), 
                                                             CP_SA = sample(PUD_C_FMD_freq$stratified_I$I$SA, 10000), 
                                                             CP_AF = sample(PUD_C_FMD_freq$stratified_I$I$AF, 10000),  
                                                             CP_AM = sample(PUD_C_FMD_freq$stratified_I$I$AM, 10000),
                                                             CP_Health_Exp = sample(Reduce("+",PUD_C_FMD_freq$stratified_I$I), 10000)),
                                       affected_change = list(CP_Milk=sample(PUD_C_FMD_freq$stratified_I$I$AF, 10000)))
PUD_C_FMD <- pert_distributions("PUD_C_FMD", PUD_C_FMD_prod)
update_AHLE_scenarios(AHLE_scenario_file="scenarios/cattle_disease_scenarios.xlsx",
                      ideal_col = "PUD_C_Ideal",
                      affected_parameters_object=PUD_C_FMD,
                      col_name = "PUD_C_FMD",
                      new_file_name = "scenarios/cattle_disease_scenarios.xlsx")

# USE JUVENILE - SUBADULT - ADULT AS AGE GROUPS
