...
# Set number of runs, scenario file location, and list scenario columns to run
# Simply comment (#) out a line if you don't want to run that set
n <- 10000
...
new_tracker_data <- results_long %>% mutate(date = Sys.Date(),
